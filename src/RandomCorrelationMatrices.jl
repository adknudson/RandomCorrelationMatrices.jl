...
Generate a d-by-d random correlation matrix using themethod described in:
...
Use randcormatrix with desired vector of standard deviations σ for each term to generate a
